...
t = self, e = function () {
    return (() => {
        ...
        async function b(t, s, n, i, r, o, h) {
            ...
            const u = y(o) ? "arraybuffer" : "text", d = await n.post(i, {
                content: o,
                headers: {...c, ...h.headers},
                responseType: u,
                timeout: h.timeout,
                ...
                try {
                    h = await this.m(t.url, {
                        ...
                        headers: {
                            ...
                            "X-Requested-With": "XMLHttpRequest", ...t.headers
                        },
                        method: t.method,
                        mode: "cors",
                        redirect: "follow",
        ...
        class x {
            ...
            parseHandshakeResponse(t) {
                ...
                const n = D.parse(e), i = JSON.parse(n[0]);
        ...
        class L {
            ...
            async gt(t) {
                const s = Date.now();
                let n = 0, i = void 0 !== t ? t : new Error("Attempting to reconnect due to a unknown error."),
                    r = this.yt(n++, 0, i);
            ...
            at(t, e, s, n) {
                ...
                } : {arguments: e, target: t, type: A.Invocation};
                {
                    ...
                    return this.L++, 0 !== n.length ? {
                        ...
                        target: t,
                        type: A.Invocation
                    } : {arguments: e, invocationId: s.toString(), target: t, type: A.Invocation}
                }
            }
            ...
            rt(t, e, s) {
                ...
                } : {arguments: e, invocationId: n.toString(), target: t, type: A.StreamInvocation}
            }
            ...
            bt(t, e, s) {
                return e ? {error: e, invocationId: t, type: A.Completion} : {
                    invocationId: t,
                    result: s,
                    type: A.Completion
                }
        ...
        class F {
            ...
            async connect(t, s) {
                ...
                const [i, r] = $(), o = {[i]: r, ...this.Pt.headers}, h = {
        ...
        class B {
            ...
            async connect(t, s) {
                ...
                return new Promise(((n, i) => {
                    let r, o = !1;
                    if (s === O.Text) {
                        if (g.isBrowser || g.isWebWorker) r = new this.Pt.EventSource(t, {withCredentials: this.Pt.withCredentials}); else {
        ...
        class X {
            ...
            Ut(t) {
                this.Wt && (this.Wt.onclose = () => {
                }, this.Wt.onmessage = () => {
                }, this.Wt.onerror = () => {
                }, this.Wt.close(), this.Wt = void 0), this.u.log(e.Trace, "(WebSockets transport) socket closed."), this.onclose && (!this.Ot(t) || !1 !== t.wasClean && 1e3 === t.code ? t instanceof Error ? this.onclose(t) : this.onclose() : this.onclose(new Error(`WebSocket closed with status code: ${t.code} (${t.reason || "no reason given"}).`)))
            }
        ...
        class J {
            constructor(t, s = {}) {
                var n;
                if (this.jt = () => {
                }, this.features = {}, this.Ft = 1, w.isRequired(t, "url"), this.u = void 0 === (n = s.logger) ? new E(e.Information) : null === n ? f.instance : void 0 !== n.log ? n : new E(n), this.baseUrl = this.Bt(t), (s = s || {}).logMessageContent = void 0 !== s.logMessageContent && s.logMessageContent, "boolean" != typeof s.withCredentials && void 0 !== s.withCredentials) throw new Error("withCredentials option was not a 'boolean' or 'undefined' value");
            ...
            async Yt(t, s, n, i) {
                ...
                const o = [], h = n.availableTransports || [];
                let a = n;
                for (const n of h) {
